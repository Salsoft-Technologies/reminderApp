...
function StartScreen({navigation}) {
    ...
    return (
      <View style={styles.headingStyleView}>
        <Text style={styles.headingTextStyle}>
          Ra
          <Image
            style={styles.iconPStyle}
            source={require('../../assets/logo/p.png')}
          />
          <Image
            style={styles.iconPStyle}
            source={require('../../assets/logo/p.png')}
    ...
    return (
      <TouchableOpacity
        ...
        <LinearGradient
          ...
          <Text style={styles.startButtonTextStyle}>Get Started</Text>
        </LinearGradient>
      </TouchableOpacity>
    );
  };
  ...
  return (
    <View
      source={require('../../assets/images/getStartedWallpaper.png')}
      style={styles.mainScreenStyle}>
